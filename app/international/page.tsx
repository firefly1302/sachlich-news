...
export const metadata: Metadata = {
  title: 'International News | Sachlich.News',
  description: 'Wichtige Nachrichten aus der Welt - sachlich aufbereitet ohne Drama und Sensationalismus.',
};
...
export default async function InternationalPage() {
  ...
  let articles = await getCachedFeed('international');

  if (!articles) {
    // Cache miss - fetch fresh
    console.log('🌍 International: Cache miss - fetching fresh data');
    const rawArticles = await fetchNewsByCategory('international');
    ...
    // Cache for 15 min
    await setCachedFeed(articles, 'international');
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Wichtige Nachrichten aus der Welt - {articles.length} Artikel</p>
      </div>
